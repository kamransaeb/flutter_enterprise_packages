...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TokenRefreshRequestModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TokenRefreshRequestModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TokenRefreshRequestModel value)?  $default,){
final _that = this;
switch (_that) {
case _TokenRefreshRequestModel() when $default != null:
return $default(_that);case _:
...
class _TokenRefreshRequestModel extends TokenRefreshRequestModel {
  const _TokenRefreshRequestModel({@JsonKey(name: 'refresh_token') required this.refreshToken}): super._();
